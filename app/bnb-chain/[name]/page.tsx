        ...
        <div className='flex flex-col gap-3' style={{ backgroundColor: '#161a1e' }}>
          <div className='p-2' style={{ backgroundColor: '#161a1e', height: '550px', width: '650px' }}>
            ...
            <TradingView
              symbol={
                (() => {
                  if (params.name === 'GROOKGIRL') {
                    return "PANCAKESWAP:GROKGIRLWBNB_7E8FF1";
                  }
                  if (params.name === '$GROKOLAUS') {
                    return "PANCAKESWAP:GROKOLAUSWBNB_86C220";
                  }
                  if (params.name === 'BABYGROK') {
                    return "PANCAKESWAP:BABYGROKXWBNB_18D2BB";
                  }
                  if (params.name === 'BABYBONK') {
                    return "PANCAKESWAP:BABYBONKWBNB_0262AA";
                  }
                  if (params.name === 'BABYGROKX') {
                    return "PANCAKESWAP:BABYGROKXWBNB_18D2BB";
                  }
                  if (params.name === 'BABYGRONK') {
                    return "PANCAKESWAP:BABYGROKXWBNB_18D2BB";
                  }
                  if (params.name === 'OPX') {
                    return "PANCAKESWAP:OPXWBNB_B61F03";
                  }
                  if (params.name === 'NAZAR') {
                    return "PANCAKESWAP:NAZARWBNB_C6FAA3";
                  }
                  if (params.name === 'KINGGROKX') {
                    return "PANCAKESWAP:KINGGROKWBNB_1BC30D";
                  }
                  if (params.name === 'AET') {
                    return "UNISWAP:HRZNWETH_102CBC.USD";
                  }
                  if (params.name === 'DADA') {
                    return "PANCAKESWAP:DADAWBNB_BE64A7";
                  }
                  if (params.name === 'GROOKDOGE') {
                    return "PANCAKESWAP:GROKDOGEWBNB_11BF31";
                  }
                  if (params.name === 'SSP') {
                    return "PANCAKESWAP:SSPFWBNB_F77EDC";
                  }
                  if (params.name === 'FINC') {
                    return "PANCAKESWAP:FINCUSDT_8C3D21";
                  }
                })() || "MIL:1CAT"
              }
            />
