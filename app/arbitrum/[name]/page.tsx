...
const Page = ({ params }: { params: { name: string } }) => {
  ...
  return (
           ...
           <span style={{ color: token?.priceUsd ? 'green' : 'black' }}>
            ...
            <TradingView
              symbol={
                (() => {
                  if (params.name === 'BOOP') {
                    return "UNISWAP:BOOPWETH_4674D4";
                  }
                  if (params.name === 'DOWN') {
                  ...
                  if (params.name === 'GLORI') {
                    return "PANCAKESWAP:BABYBONKWBNB_0262AA";
                  }
                  if (params.name === 'ARJ') {
                    return "UNISWAP3ARBITRUM:ARJWETH";
                  }
                })() || "MIL:1CAT"
              }
            /> 
    ...
    {view === 'sellers' && (
      ...
      <div className=" flex-col" style={{ backgroundColor: '#ffffff', height: '100px', width: '300px' }}>
            {
              view === 'wallet' && (
                <>
                {
                  setwallet && (
                    <div className=' flex history-box gap-2 text-sm' style={{height: '100px', width: '300px'}}>
                        <h1>XX</h1>
                    </div>
                  )
                }
