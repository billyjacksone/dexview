...
const ConnectBox: React.FC<ConnectBoxProps> = ({ onClose, onConnect }) => {
...
const ConnectButton: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {isConnectBoxOpen && <ConnectBox onClose={() => setIsConnectBoxOpen(false)} onConnect={setIsMetaMaskConnected} />}
    </div>
  );
};
