  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ backgroundColor: '#161a1e', height: '120px', marginBottom: '10px', padding: '6px' }}>
          {account && (
            <div>
              Connected Account: {`${account.substring(0, 7)}...${account.slice(-5)}`}
              <br />
              WELCOME
              {/* <button onClick={disconnectWallet} className="text-red px-2 py-1 rounded-md transition-all ">
                Disconnect
              </button> */}
            </div>
          )}
