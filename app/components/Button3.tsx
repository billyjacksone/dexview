...
import MailIcon from '@/public/lines.svg';
...
const ConnectBox: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const renderAccountInfo = () => {
    if (account) {
      ...
      return (
        <div style={{padding: '10px', paddingTop: '20px', paddingLeft:' 25px'}}><Button /></div>
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ backgroundColor: '#161a1e', height: '100px', marginBottom: '10px', padding: '8px' }}>
        {renderAccountInfo()}
