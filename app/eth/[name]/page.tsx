        ...
        <div className='flex flex-col gap-3' style={{ backgroundColor: '#161a1e' }}>
          <div className='p-2' style={{ backgroundColor: '#161a1e', height: '550px', width: '650px' }}>
            ...
            <TradingView
              symbol={
                (() => {
                  if (params.name === 'HEMULE') {
                    return "UNISWAP3ETH:HEMULEWETH";
                  }
                  if (params.name === 'WEXO') {
                    return "UNISWAP:WEXOWETH_8ABDB4";
                  }
                  if (params.name === '1CAT') {
                    return "UNISWAP3ETH:1CATWETH";
                  }
                  if (params.name === 'OBTC') {
                    return "UNISWAP:OBTCWETH_AF6050.USD";
                  }
                  if (params.name === 'MND') {
                    return "UNISWAP:MNDWETH_983226.USD";
                  }
                  if (params.name === 'ENQAI') {
                    return "UNISWAP:ENQAIWETH_DCE6E9";
                  }
                  if (params.name === 'LEMON') {
                    return "UNISWAP:LEMONWETH_7E10E6";
                  }
                  if (params.name === 'DGEN') {
                    return "UNISWAP3ETH:DGENWETH";
                  }
                  if (params.name === 'XMAS') {
                    return "UNISWAP:XMASWETH_187B42.USD";
                  }
                  if (params.name === 'HRZN') {
